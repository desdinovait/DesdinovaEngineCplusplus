...
//Name
string	Material_Name			= "Ice";

//Physics properties
float	Material_Density		= 1000.0f;		//See table of densities
float	Material_Restitution		= 1.0f;			//Should not be higher than 1
float	Material_StaticFriction		= 0.0f;			//Can be higher than 1
float	Material_DynamicFriction	= 0.0f;			//Should not be higher than 1
...
float	Material_Shininess		= 500.0f;
